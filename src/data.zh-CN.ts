...
const data: AppData = {
  ...
  ui: {
    ...
    hintFinals: '-n 和 -ng 听起来容易混淆，但阻碍位置不同：-n 的阻碍在口腔前部的齿龈，-ng 的阻碍在口腔后部的软腭。可把手指轻放在下巴下方；发 -ng 时，应能感觉到舌根抬起。'
  },
  ...
  initials: [
    ...
    { id: 'velar', pinyin: 'g · k · h', name: '舌根音', marker: { x: 302, y: 114 }, noContact: false,
      ...
      body: '舌尖不参与发音，放松地停在下齿后方。<b>舌根</b>抬起并接近或接触软腭，阻碍位置在口腔后部。',
      example: 'gōngzuò → 工作' }
  ],
  ...
  finals: [
    ...
    { id: 'ng', pinyin: '-ng', name: '后鼻音韵尾', marker: { x: 302, y: 114 }, noContact: false,
      ...
      velum: true,
      title: '舌位同 g、k，软腭下降',
      body: '舌根抬向软腭，位置与发 <b>g、k</b> 时相同；与此同时，软腭下降，气流转而通过鼻腔。舌尖不要参与：-ng 的阻碍完全位于口腔后部。',
